...
activities = {
    ...
    "Swimming Club": {
        "description": "Swim training and endurance exercises",
    ...
    "Drama Club": {
        "description": "Prepare theatrical performances and acting workshops",
    ...
    "Book Club": {
        "description": "Read and discuss books across genres",
